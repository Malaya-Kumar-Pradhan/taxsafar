...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Taxsafar — Compliance, simplified" },
      { property: "og:description", content: "Tech-driven CA consultancy for GST, Income Tax, registrations and more." },
